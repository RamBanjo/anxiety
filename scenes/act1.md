...
b: ...คาดหวังว่าเราจะไม่ไปแล้วให้เขาสนุกกับปาร์ตี้ที่ไม่มีตัวกาลกิณีน่ารังเกียจ{{if _.whitebread}}ที่ชอบกินขนมปังขาว{{/if}}แบบเร--
...
b: ทวิตเก่าๆที่มีปัญหามันกลับมาหลอกหลอนเราแล้ว!
...
b: เราจะถูกประณาม แล้วถูกคว่ำบาตร แล้วเราก็จะถูกลากบนโลกอินเตอร์เน็ต ถูกประจานให้ทุกคนรับรู้!
