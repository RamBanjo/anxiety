...
{{if !_.INJURED}}
b: ยกตัวอย่างนะe: เราเกือบกระโดดจาก *หลังคาตึก!*
{{/if}}
...
h: เราสามารถฝึกสกิลการสื่อสาร เช่น การถามคำถาม การฟังและการทำความเข้าใจ การเปิดใจและยอมรับจุดอ่อนของเรา เป็นต้น?
...
b: เราจะเลียตูดใครต่อใครจนปากจะมีลิปสติ๊กสีน้ำตาล!
...
h: อีกอย่าง... เรี่องลิปสติ๊กมัน... *แหวะ??*
...
h: แบบว่า ไอ้พวก "สกิลการสื่อสาร" ^ห่าเหว^ที่นักจิตวิทยาชอบใส่ในใบปลิวน่ะ
...
b: เออไอ้ fourth wall นี่อยู่ไม่นานแฮะ

`hong({ body:"point" });`

h: บางอย่างสำคัญกว่าการเล่าเรี่องล่ะ สุขภาพจิตเป็นต้น
...
h: แบบว่า นักจิตวิทยาชอบผูดกันใช่มั้ยล่ะ? ยอมรับอารมณ์ของเรา รวมถึงอารมณ์ทางลบด้วย?
...
{{if _.TOP_FEAR=="harm"}}
s: *นี่* คนที่แกชอบเหรอ? ทำไมเขาถึงนั่งคนเดียวเป็นฆาตกรโรคจิต?
{{/if}}
...
{{if _.TOP_FEAR=="alone"}}
s: ว้าาาก ความทรงจำแรกของเขาเกี่ยวกับเราคือ "เห็นทรอม่าของชั้น"! หมายความว่าเขาเกลียดเรา!
{{/if}}
...
h2: จะบอกแค่ว่า ถ้าอยากนั่งตรงนี้ก็ได้
...
{{if _.TOP_FEAR=="harm"}}
s: เขาคิดอะไรแปลกๆ ในหัวอยู่?! เจ้าโรคจิตนั่นมันมันมีอะไรในใจสุดลึกล้ำ?!
{{/if}}

{{if _.TOP_FEAR=="alone"}}
s: เราเพี่งถูกปฎิเสธ! เราจะไม่มีใครรักตลอดกาล!
{{/if}}
